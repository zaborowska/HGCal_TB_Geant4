...
void defineConfig22_October2018_1(std::vector<std::pair<std::string, G4double> > &dz_map, G4double &viewpoint) {
  ...
  //EE1
  dz_map.push_back(std::make_pair("Pb_absorber_EE", 12 * cm)); // total 13 mm
  ...
  dz_map.push_back(std::make_pair("Al_case", 0.6 * cm)); // 2.6 mm

  //EE2
  dz_map.push_back(std::make_pair("Pb_absorber_EE", 0.5 * cm)); // 4.9mm
  dz_map.push_back(std::make_pair("PCB", 0.7 * cm)); // 1.9mm
  dz_map.push_back(std::make_pair("Si_wafer", 0.)); // 0.3 mm
  dz_map.push_back(std::make_pair("Kapton_layer", 0.)); // 0.05 mm
  dz_map.push_back(std::make_pair("CuW_baseplate", 0.)); //1.2 mm
  dz_map.push_back(std::make_pair("Cu_absorber_EE", 0.)); // 1.2 mm
  dz_map.push_back(std::make_pair("CuW_baseplate", 0.)); // 1.2 mm
  dz_map.push_back(std::make_pair("Kapton_layer", 0.)); // 0.05 mm
  dz_map.push_back(std::make_pair("Si_wafer", 0.)); // 0.3 mm
  dz_map.push_back(std::make_pair("PCB", 0)); // 1.9 mm
  // total material: 13 mm

  //EE3
  dz_map.push_back(std::make_pair("Pb_absorber_EE", 1.1 * cm));  // total 13 mm
  ...
  //EE4
  dz_map.push_back(std::make_pair("Pb_absorber_EE", 1.2 * cm)); // total 13 mm
  dz_map.push_back(std::make_pair("PCB", 0.7 * cm));
  dz_map.push_back(std::make_pair("Si_wafer", 0.));
  dz_map.push_back(std::make_pair("Kapton_layer", 0.));
  dz_map.push_back(std::make_pair("CuW_baseplate", 0.));
  ...
  //EE7
  dz_map.push_back(std::make_pair("Pb_absorber_EE", 1.0 * cm)); // total 13 mm
  dz_map.push_back(std::make_pair("PCB", 0.7 * cm));
  dz_map.push_back(std::make_pair("Si_wafer", 0.));
  dz_map.push_back(std::make_pair("Kapton_layer", 0.));
  dz_map.push_back(std::make_pair("CuW_baseplate", 0.));
  ...
  //EE12
  dz_map.push_back(std::make_pair("Pb_absorber_EE", 1.4 * cm)); // total 13 mm
  dz_map.push_back(std::make_pair("PCB", 1.0 * cm));
  dz_map.push_back(std::make_pair("Si_wafer", 0.));
  dz_map.push_back(std::make_pair("Kapton_layer", 0.));
  dz_map.push_back(std::make_pair("CuW_baseplate", 0.));
  ...
  dz_map.push_back(std::make_pair("Al_case", 8.4 * cm)); // 2.6 mm

  //beginning of FH
  dz_map.push_back(std::make_pair("Steel_case", 3.5 * cm)); // 9 mm
