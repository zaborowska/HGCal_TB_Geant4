...
G4SubtractionSolid* HexagonSolid(G4String aName, G4double aCellThickness, G4double aCellSideLength) {
  ...
  G4Box* solidFullcell = new G4Box(aName,                       //its aName
                                   0.5 * fullCcellX, 0.5 * fullCellY, 0.5 * aCellThickness); //its size
  ...
  G4Box* solidCutcell = new G4Box(aName,                       //its aName
                                  0.5 * deltaXDash, 0.5 * (deltaYDash), 1.*aCellThickness); //its size
...
void HGCalTBMaterials::DefineSiWaferAndCells() {
  ...
  fSiWaferLogical = HexagonLogical("Si_wafer", fSiWaferThickness, fSiWaferSideLength, fMatAIR);

  //Silicon pixel setups
  double dx = 2 * sin(fAlpha) * fSiPixelSideLength;
  double dy = fSiPixelSideLength * (2. + 2 * cos(fAlpha));
  fSiPixelLogical = HexagonLogical("SiCell", fSiWaferThickness, fSiPixelSideLength, fMatSi);

  int index = 1;
  int nRows[11] = {7, 6, 7, 6, 5, 6, 5, 4, 5, 4, 3};
  for (int nC = 0; nC < 11; nC++) {
    for (int middle_index = 0; middle_index < nRows[nC]; middle_index++) {
      new G4PVPlacement(0, G4ThreeVector(dy * (middle_index - nRows[nC] / 2. + 0.5), nC * dx / 2, 0.), fSiPixelLogical, "SiCell", fSiWaferLogical, false, index++, true);
      if (nC <= 0) continue;
      new G4PVPlacement(0, G4ThreeVector(dy * (middle_index - nRows[nC] / 2. + 0.5), -nC * dx / 2, 0.), fSiPixelLogical, "SiCell", fSiWaferLogical, false, index++, true);
    }
  }
...
void HGCalTBMaterials::DefineHGCalBaseplates() {
  ...
  fCuWbaseplateLogical = HexagonLogical("CuW_baseplate", CuWbaseplateThickness, CuWbaseplatesideLength, fMatCuW);
  ...
  fCuWbaseplate550umLogical = HexagonLogical("CuW_baseplate_550um", CuWbaseplate550umthickness, CuWbaseplatesideLength, fMatCuW);
  ...
  fCuWbaseplate610umLogical = HexagonLogical("CuW_baseplate_610um", CuWbaseplate610umThickness, CuWbaseplatesideLength, fMatCuW);
  ...
  fCuWbaseplate710umLogical = HexagonLogical("CuW_baseplate_710um", CuWbaseplate710umThickness, CuWbaseplatesideLength, fMatCuW);
  ...
  fCuBaseplateLogical = HexagonLogical("Cu_baseplate", CuBaseplateThickness, CuBaseplatesideLength, fMatCu);
  ...
  fCuBaseplate25umLogical = HexagonLogical("Cu_baseplate_25um", CuBaseplate25umThickness, CuBaseplatesideLength, fMatCu);
  ...
  fCuBaseplate175umLogical = HexagonLogical("Cu_baseplate_175um", CuBaseplate175umThickness, CuBaseplatesideLength, fMatCu);
  ...
  fPCBbaseplateLogical = HexagonLogical("PCB", PCBbaseplateThickness, PCBbaseplateSideLength, fMatPCB);
  ...
  fPCBbaseplateThinLogical = HexagonLogical("PCB_thin", PCBbaseplateThinThickness, PCBbaseplateSideLength, fMatPCB);
  ...
  fKaptonLayerLogical = HexagonLogical("Kapton_layer", KaptonLayerThickness, KaptonLayerSideLength, fMatKAPTON);
...
void HGCalTBMaterials::DefineHGCalCases() {
  ...
  G4Box* AlCaseSolid = new G4Box("Al_case", 0.5 * AlCaseXY, 0.5 * AlCaseXY, 0.5 * AlCaseThickness);
  ...
  G4Box* AlCaseThickSolid = new G4Box("Al_case_thick", 0.5 * AlCaseXY, 0.5 * AlCaseXY, 0.5 * AlCaseThickThickness);
  fAlCaseThickLogical = new G4LogicalVolume(AlCaseThickSolid, fMatAl, "Al_case_thick");
  ...
  G4Box* SteelCaseSolid = new G4Box("Steel_case", 0.5 * SteelCaseXY, 0.5 * SteelCaseXY, 0.5 * SteelCaseThickness);
  ...
  G4Box* SteelCaseThickSolid = new G4Box("Steel_case_thick", 0.5 * SteelCaseXY, 0.5 * SteelCaseXY, 0.5 * SteelCaseThickThickness);
  fSteelCaseThickLogical = new G4LogicalVolume(SteelCaseThickSolid, fMatFe, "Steel_case_thick");
...
void HGCalTBMaterials::DefineHGCalEEAbsorbers() {
  ...
  G4Box* PbAbsorberEEsolid = new G4Box("Pb_absorber_EE", 0.5 * PbAbsorberEExy, 0.5 * PbAbsorberEExy, 0.5 * PbAbsorberEEthickness);
  fPbAbsorberEElogical = new G4LogicalVolume(PbAbsorberEEsolid, fMatPb, "Pb_absorber_EE");
  ...
  G4Box* FeAbsorberEEsolid = new G4Box("Fe_absorber_EE", 0.5 * FeAbsorberEExy, 0.5 * FeAbsorberEExy, 0.5 * FeAbsorberEEthickness);
  fFeAbsorberEElogical = new G4LogicalVolume(FeAbsorberEEsolid, fMatFe, "Fe_absorber_EE");
  ...
  G4Box* CuAbsorberEEsolid = new G4Box("Cu_absorber_EE", 0.5 * CuAbsorberEExy, 0.5 * CuAbsorberEExy, 0.5 * CuAbsorberEEthickness);
  fCuAbsorberEElogical = new G4LogicalVolume(CuAbsorberEEsolid, fMatCu, "Cu_absorber_EE");
  ...
  G4Box* WabsorberEEsolid = new G4Box("W_absorber_EE", 0.5 * WabsorberEExy, 0.5 * WabsorberEExy, 0.5 * WabsorberEEthickness);
  fWabsorberEElogical = new G4LogicalVolume(WabsorberEEsolid, fMatW, "W_absorber_EE");
  ...
  G4Box* W2mmAbsorberEEDESY2018solid = new G4Box("W_2mm_absorber_EE_DESY2018", 0.5 * W2mmAbsorberEEDESY2018xy, 0.5 * W2mmAbsorberEEDESY2018xy, 0.5 * W2mmAbsorberEEDESY2018thickness);
  fW2mmAbsorberEEDESY2018Logical = new G4LogicalVolume(W2mmAbsorberEEDESY2018solid, fMatW, "W_2mm_absorber_EE_DESY2018");
  fThicknessMap["W_2mm_absorber_EE_DESY2018"] = W2mmAbsorberEEDESY2018thickness;
  fLogicalVolumeMap["W_2mm_absorber_EE_DESY2018"] = fW2mmAbsorberEEDESY2018Logical;


  G4double W4mmAbsorberEEDESY2018thickness = 4. * mm;
  G4double W4mmAbsorberEEDESY2018xy = 15 * cm;
  G4Box* W4mmAbsorberEEDESY2018solid = new G4Box("W_4mm_absorber_EE_DESY2018", 0.5 * W4mmAbsorberEEDESY2018xy, 0.5 * W4mmAbsorberEEDESY2018xy, 0.5 * W4mmAbsorberEEDESY2018thickness);
  fW4mmAbsorberEEDESY2018Logical = new G4LogicalVolume(W4mmAbsorberEEDESY2018solid, fMatW, "W_4mm_absorber_EE_DESY2018");
...
void HGCalTBMaterials::DefineHGCalFHAbsorbers() {
  ...
  G4Box* CuAbsorberFHsolid = new G4Box("Cu_absorber_FH", 0.5 * CuAbsorberFHxy, 0.5 * CuAbsorberFHxy, 0.5 * CuAbsorberFHthickness);
  fCuAbsorberFHlogical = new G4LogicalVolume(CuAbsorberFHsolid, fMatCu, "Cu_absorber_FH");
  ...
  G4Box* FeAbsorberFHsolid = new G4Box("Fe_absorber_FH", 0.5 * FeAbsorberFHxy, 0.5 * FeAbsorberFHxy, 0.5 * FeAbsorberFHthickness);
  fFeAbsorberFHlogical = new G4LogicalVolume(FeAbsorberFHsolid, fMatFe, "Fe_absorber_FH");
...
void HGCalTBMaterials::DefineAHCALSiPM() {
  ...
  fAHCALSiPMxy = 3 * cm;
  fAHCALSiPMsolid = new G4Box("AHCAL_SiPM", 0.5 * fAHCALSiPMxy, 0.5 * fAHCALSiPMxy, 0.5 * AHCALSiPMthickness);
  fAHCALSiPMlogical = new G4LogicalVolume(fAHCALSiPMsolid, fMatPolystyrene, "AHCAL_SiPM");
  ...
  G4Box* AHCALSiPM2x2HUBsolid = new G4Box("AHCAL_SiPM_2x2HUB", 0.5 * AHCALSiPM2x2HUBxy, 0.5 * AHCALSiPM2x2HUBxy, 0.5 * AHCALSiPM2x2HUBthickness);
  fAHCALSiPM2x2HUBlogical = new G4LogicalVolume(AHCALSiPM2x2HUBsolid, fMatAIR, "AHCAL_SiPM_2x2HUB");
...
void HGCalTBMaterials::DefineAHCALAbsorbers() {
  ...
  G4Box* AlAbsorberAHCALsolid = new G4Box("Al_absorber_AHCAL", 0.5 * AlAbsorberAHCALxy, 0.5 * AlAbsorberAHCALxy, 0.5 * AlAbsorberAHCALthickness);
  fAlAbsorberAHCALlogical = new G4LogicalVolume(AlAbsorberAHCALsolid, fMatAl, "Al_absorber_AHCAL");
  ...
  G4Box* PCBAHCALsolid = new G4Box("PCB_AHCAL", 0.5 * PCBAHCALxy, 0.5 * PCBAHCALxy, 0.5 * PCBAHCALthickness);
  ...
  G4Box* FeAbsorberAHCALsolid = new G4Box("Fe_absorber_AHCAL", 0.5 * FeAbsorberAHCALx, 0.5 * FeAbsorberAHCALy, 0.5 * FeAbsorberAHCALthickness);
  fFeAbsorberAHCALlogical = new G4LogicalVolume(FeAbsorberAHCALsolid, fMatFe, "Fe_absorber_AHCAL");
...
void HGCalTBMaterials::DefineBeamLineElements() {
  ...
  G4Box* scintillatorSolid = new G4Box("Scintillator", 0.5 * scintillatorXY, 0.5 * scintillatorXY, 0.5 * scintillatorThickness);
  fScintillatorLogical = new G4LogicalVolume(scintillatorSolid, fMatScintillator, "Scintillator");
  ...
  G4Box* fScintillatorThinSolid = new G4Box("Scintillator_thin", 0.5 * scintillatorXY, 0.5 * scintillatorXY, 0.5 * fScintillatorThinThickness);
  fScintillatorThinLogical = new G4LogicalVolume(fScintillatorThinSolid, fMatScintillator, "Scintillator_thin");
  ...
  G4Tubs* MCPsolid = new G4Tubs("MCP", 0. , MCPradius, MCPthickness, 0, 360 * degree);
  ...
  G4Tubs* CK3solid = new G4Tubs("CK3", 0. , CK3radius, 0.5 * CK3thickness, 0, 360 * degree);
  ...
  G4Box* AlChipSolid = new G4Box("Al_chip", 0.5 * AlChipXY, 0.5 * AlChipXY, 0.5 * AlChipThickness);
  ...
  G4Box* DWCsolid = new G4Box("DWC", 0.5 * DWCxy, 0.5 * DWCxy, 0.5 * DWCthickness);
  ...
  G4Box * DWCgasSolid = new G4Box("DWC_gas", 0.5 * DWCgasXY, 0.5 * DWCgasXY, 0.5 * DWCgasThickness);
  fDWCgasLogical = new G4LogicalVolume(DWCgasSolid, fMatArCO2, "DWC_gas");
  new G4PVPlacement(0, G4ThreeVector(0, 0., 0.), fDWCgasLogical, "DWC_gas", fDWClogical, false, 0, true);

  // WChambWindow
  G4double DWCwindowThickness = 0.025 * mm;
  G4double DWCwindowXY = 2 * 5.5 * cm;
  G4Box * DWCwindowSolid = new G4Box("DWC_window", 0.5 * DWCwindowXY, 0.5 * DWCwindowXY, 0.5 * DWCwindowThickness);
  auto DWCwindowLogical = new G4LogicalVolume(DWCwindowSolid, fMatKAPTON, "DWC_window");
  new G4PVPlacement(0, G4ThreeVector(0, 0., 27.5 * mm - DWCwindowThickness / 2.), DWCwindowLogical, "DWC_window_0", fDWClogical, true, 0, true);
  new G4PVPlacement(0, G4ThreeVector(0, 0., - (27.5 * mm - DWCwindowThickness / 2.) ), DWCwindowLogical, "DWC_window_1", fDWClogical, true, 1, true);
  ...
  G4Box * DWCal1solid = new G4Box("DWC_al1", 0.5 * DWCal1x, 0.5 * DWCal1y, 0.5 * DWCal1thickness);
  auto DWCal1logical = new G4LogicalVolume(DWCal1solid, fMatAl, "DWC_al1");
  new G4PVPlacement(0, G4ThreeVector(0.5 * DWCal1y, 0.5 * DWCal1x, (0.5 * DWCthickness - 0.5 * DWCal1thickness)), DWCal1logical, "DWC_al1_0", fDWClogical, true, 0, true);
  new G4PVPlacement(rotation, G4ThreeVector(-0.5 * DWCal1x, 0.5 * DWCal1y, (0.5 * DWCthickness - 0.5 * DWCal1thickness)), DWCal1logical, "DWC_al1_1", fDWClogical, true, 1, true);
  new G4PVPlacement(0, G4ThreeVector(-0.5 * DWCal1y, -0.5 * DWCal1x, (0.5 * DWCthickness - 0.5 * DWCal1thickness)), DWCal1logical, "DWC_al1_2", fDWClogical, true, 2, true);
  new G4PVPlacement(rotation, G4ThreeVector(0.5 * DWCal1x, -0.5 * DWCal1y, (0.5 * DWCthickness - 0.5 * DWCal1thickness)), DWCal1logical, "DWC_al1_3", fDWClogical, true, 3, true);
  new G4PVPlacement(0, G4ThreeVector(0.5 * DWCal1y, 0.5 * DWCal1x, -(0.5 * DWCthickness - 0.5 * DWCal1thickness)), DWCal1logical, "DWC_al1_4", fDWClogical, true, 4, true);
  new G4PVPlacement(rotation, G4ThreeVector(-0.5 * DWCal1x, 0.5 * DWCal1y, -(0.5 * DWCthickness - 0.5 * DWCal1thickness)), DWCal1logical, "DWC_al1_5", fDWClogical, true, 5, true);
  new G4PVPlacement(0, G4ThreeVector(-0.5 * DWCal1y, -0.5 * DWCal1x, -(0.5 * DWCthickness - 0.5 * DWCal1thickness)), DWCal1logical, "DWC_al1_6", fDWClogical, true, 6, true);
  new G4PVPlacement(rotation, G4ThreeVector(0.5 * DWCal1x, -0.5 * DWCal1y, -(0.5 * DWCthickness - 0.5 * DWCal1thickness)), DWCal1logical, "DWC_al1_7", fDWClogical, true, 7, true);

  // WChambAl2
  G4double DWCal2thickness = 2 * 2.25* cm;
  G4double DWCal2x = 2 * 10.75 * cm;
  G4double DWCal2y = 2 * 2.5 * mm;
  G4Box * DWCal2solid = new G4Box("DWC_al2", 0.5 * DWCal2x, 0.5 * DWCal2y, 0.5 * DWCal2thickness);
  auto DWCal2logical = new G4LogicalVolume(DWCal2solid, fMatAl, "DWC_al2");
  new G4PVPlacement(0, G4ThreeVector(0.5 * DWCal2y, 0.5 * DWCal2x, 0), DWCal2logical, "DWC_al2_0", fDWClogical, true, 0, true);
  new G4PVPlacement(rotation, G4ThreeVector(-0.5 * DWCal2x, 0.5 * DWCal2y, 0), DWCal2logical, "DWC_al2_1", fDWClogical, true, 1, true);
  new G4PVPlacement(0, G4ThreeVector(-0.5 * DWCal2y, -0.5 * DWCal2x, 0), DWCal2logical, "DWC_al2_2", fDWClogical, true, 2, true);
  new G4PVPlacement(rotation, G4ThreeVector(0.5 * DWCal2x, -0.5 * DWCal2y, 0), DWCal2logical, "DWC_al2_3", fDWClogical, true, 3, true);

  // WChambGasVet
  G4double DWCgasVetThickness = 2 * 2.5* mm;
  G4double DWCgasVetX = 2 * 7.25 * cm;
  G4double DWCgasVetY = 2 * 1.25 * cm;
  G4Box * DWCgasVetSolid = new G4Box("DWC_gasVet", 0.5 * DWCgasVetX, 0.5 * DWCgasVetY, 0.5 * DWCgasVetThickness);
  auto DWCgasVetLogical = new G4LogicalVolume(DWCgasVetSolid, fMatPolyethylene, "DWC_gasVet");
  new G4PVPlacement(0, G4ThreeVector(0.5 * DWCgasVetY, 0.5 * DWCgasVetX, 0.5 * (DWCgasThickness - DWCgasVetThickness)), DWCgasVetLogical, "DWC_gasVet_0", fDWCgasLogical, true, 0, true);
  new G4PVPlacement(rotation, G4ThreeVector(-0.5 * DWCgasVetX, 0.5 * DWCgasVetY, 0.5 * (DWCgasThickness - DWCgasVetThickness)), DWCgasVetLogical, "DWC_gasVet_1", fDWCgasLogical, true, 1, true);
  new G4PVPlacement(0, G4ThreeVector(-0.5 * DWCgasVetY, -0.5 * DWCgasVetX, 0.5 * (DWCgasThickness - DWCgasVetThickness)), DWCgasVetLogical, "DWC_gasVet_2", fDWCgasLogical, true, 2, true);
  new G4PVPlacement(rotation, G4ThreeVector(0.5 * DWCgasVetX, -0.5 * DWCgasVetY, 0.5 * (DWCgasThickness - DWCgasVetThickness)), DWCgasVetLogical, "DWC_gasVet_3", fDWCgasLogical, true, 3, true);
  new G4PVPlacement(0, G4ThreeVector(0.5 * DWCgasVetY, 0.5 * DWCgasVetX, 0), DWCgasVetLogical, "DWC_gasVet_4", fDWCgasLogical, true, 4, true);
  new G4PVPlacement(rotation, G4ThreeVector(-0.5 * DWCgasVetX, 0.5 * DWCgasVetY, 0), DWCgasVetLogical, "DWC_gasVet_5", fDWCgasLogical, true, 5, true);
  new G4PVPlacement(0, G4ThreeVector(-0.5 * DWCgasVetY, -0.5 * DWCgasVetX, 0), DWCgasVetLogical, "DWC_gasVet_6", fDWCgasLogical, true, 6, true);
  new G4PVPlacement(rotation, G4ThreeVector(0.5 * DWCgasVetX, -0.5 * DWCgasVetY, 0), DWCgasVetLogical, "DWC_gasVet_7", fDWCgasLogical, true, 7, true);
  new G4PVPlacement(0, G4ThreeVector(0.5 * DWCgasVetY, 0.5 * DWCgasVetX, -0.5 * (DWCgasThickness - DWCgasVetThickness)), DWCgasVetLogical, "DWC_gasVet_8", fDWCgasLogical, true, 8, true);
  new G4PVPlacement(rotation, G4ThreeVector(-0.5 * DWCgasVetX, 0.5 * DWCgasVetY, -0.5 * (DWCgasThickness - DWCgasVetThickness)), DWCgasVetLogical, "DWC_gasVet_9", fDWCgasLogical, true, 9, true);
  new G4PVPlacement(0, G4ThreeVector(-0.5 * DWCgasVetY, -0.5 * DWCgasVetX, -0.5 * (DWCgasThickness - DWCgasVetThickness)), DWCgasVetLogical, "DWC_gasVet_10", fDWCgasLogical, true, 10, true);
  new G4PVPlacement(rotation, G4ThreeVector(0.5 * DWCgasVetX, -0.5 * DWCgasVetY, -0.5 * (DWCgasThickness - DWCgasVetThickness)), DWCgasVetLogical, "DWC_gasVet_11", fDWCgasLogical, true, 11, true);
  ...
  G4Box* DATURAfullSolid = new G4Box("DATURA_full", 0.5 * DATURAxy, 0.5 * DATURAxy, 0.5 * DATURAthickness);
  G4Box* DATURAcutSolid = new G4Box("DATURA_cut", 0.5 * DATURAwindowX, 0.5 * DATURAwindowY, 0.5 * DATURAthickness);
  G4SubtractionSolid* DATURAsolid = new G4SubtractionSolid("DATURA", DATURAfullSolid, DATURAcutSolid, 0, G4ThreeVector(0, 0, 0.));
...
void HGCalTBMaterials::DefineHERDCalorimeter(){ 
  ...
  G4Box* HERDcalorimeterSolid = new G4Box("HERD_calorimeter", 0.5 * HERDcalorimeterXY, 0.5 * HERDcalorimeterXY, 0.5 * HERDcalorimeterThickness);
  fHERDcalorimeterLogical = new G4LogicalVolume(HERDcalorimeterSolid, fMatLYSO, "HERD_calorimeter");
  ...
  G4double HERDcalorimeterSlabThickness = HERDcalorimeterThickness + 0.0001 * mm;
  G4Box* HERDcalorimeterSlabSolid = new G4Box("HERD_calorimeter_slab", 0.5 * HERDcalorimeterSlabXY, 0.5 * HERDcalorimeterSlabXY, 0.5 * HERDcalorimeterSlabThickness);
  fHERDcalorimeterSlabLogical = new G4LogicalVolume(HERDcalorimeterSlabSolid, fMatAIR, "HERD_calorimeter_slab");
  ...
  for (float _dx = -10.0; _dx <= 10.0; _dx = _dx + 1.) for (float _dy = -10.0; _dy <= 10.0; _dy = _dy + 1.) {
      new G4PVPlacement(0, G4ThreeVector(_dx * HERDcalorimeterXY, _dy * HERDcalorimeterXY, 0), fHERDcalorimeterLogical, "HERD_calorimeter_slab",  fHERDcalorimeterSlabLogical, false, copy_counter++, true);  
  }
}
...
void HGCalTBMaterials::PlaceItemInLogicalVolume(std::string aName, G4double &aZ0, G4LogicalVolume* aLogicMother) {
  if (aName.find("_DAISY") != std::string::npos) {
    ...
    if (fCopyCounterMap.find(aName) == fCopyCounterMap.end()) fCopyCounterMap[aName] = 0;
    ...
    for (int nC = 0; nC < 3; nC++) {
      for (int middle_index = 0; middle_index < nRows_[nC]; middle_index++) {
        new G4PVPlacement(0, G4ThreeVector(dy_ * (middle_index - nRows_[nC] / 2. + 0.5) , -nC * dx_ / 2 , aZ0 + 0.5 * fThicknessMap[aName]), fLogicalVolumeMap[aName], aName, aLogicMother, false, fCopyCounterMap[aName]++, true);
        if (nC <= 0) continue;
        new G4PVPlacement(0, G4ThreeVector(dy_ * (middle_index - nRows_[nC] / 2. + 0.5) , +nC * dx_ / 2 , aZ0 + 0.5 * fThicknessMap[aName]), fLogicalVolumeMap[aName], aName, aLogicMother, false, fCopyCounterMap[aName]++, true);
      }
    }
    ...
    for (int nC = 0; nC < 2; nC++) {
      new G4PVPlacement(0, G4ThreeVector(-dy_ * (0 - nRows_[nC] / 2. + 0.5) , -nC * dx_ / 2 , aZ0 + 0.5 * fThicknessMap[aName]), fLogicalVolumeMap[aName], aName, aLogicMother, false, fCopyCounterMap[aName]++, true);
      if (nC <= 0) continue;
      new G4PVPlacement(0, G4ThreeVector(-dy_ * (0 - nRows_[nC] / 2. + 0.5) , +nC * dx_ / 2 , aZ0 + 0.5 * fThicknessMap[aName]), fLogicalVolumeMap[aName], aName, aLogicMother, false, fCopyCounterMap[aName]++, true);
    }
    aZ0 += fThicknessMap[aName];
    ...
    G4RotationMatrix* rot = new G4RotationMatrix;
    rot->rotateZ(30 * deg);
    new G4PVPlacement(rot, G4ThreeVector(0, 0, aZ0 + 0.5 * fThicknessMap[aName]), fLogicalVolumeMap[aName], aName, aLogicMother, false, fCopyCounterMap[aName]++, true);
    aZ0 += fThicknessMap[aName];
  } else {
    if (fCopyCounterMap.find(aName) == fCopyCounterMap.end()) fCopyCounterMap[aName] = 0;
    new G4PVPlacement(0, G4ThreeVector(0, 0, aZ0 + 0.5 * fThicknessMap[aName]), fLogicalVolumeMap[aName], aName, aLogicMother, false, fCopyCounterMap[aName]++, true);
    aZ0 += fThicknessMap[aName];
  }
}
