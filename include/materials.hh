...
private:
	...
	G4LogicalVolume* CuW_baseplate_550um_logical;
	G4LogicalVolume* CuW_baseplate_610um_logical;
	G4LogicalVolume* CuW_baseplate_710um_logical;
	G4LogicalVolume* Cu_baseplate_logical;
	G4LogicalVolume* Cu_baseplate_25um_logical;
	G4LogicalVolume* Cu_baseplate_175um_logical;
	G4LogicalVolume* PCB_baseplate_logical;
	G4LogicalVolume* PCB_baseplate_thin_logical;
	G4LogicalVolume* Kapton_layer_logical;
	G4LogicalVolume* Al_case_logical;
	G4LogicalVolume* Al_case_thick_logical;
	G4LogicalVolume* Al_chip_logical;
	G4LogicalVolume* Steel_case_logical;
	G4LogicalVolume* Steel_case_thick_logical;
	G4LogicalVolume* Pb_absorber_EE_logical;
	G4LogicalVolume* Fe_absorber_EE_logical;
